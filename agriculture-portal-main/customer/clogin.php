...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Connexion Client</a>
         ...
         <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
           <div class="card card-body bg-gradient-danger">
            ...
            <div class="input-group mb-3">
              ...
              <input name="cust_password" type="password"  class="input form-control" id="password" placeholder="Mot de Passe" required="true" aria-label="password" aria-describedby="basic-addon1" />
