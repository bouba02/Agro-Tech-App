            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="card mb-3">
                <div class="card-body bg-gradient-success">
                  ...
                  <div class="row mb-1">
                    <div class="col-sm-3">
                      <h6 class="mb-0 font-weight-bold"> ID Client</h6>
                    </div>
                  ...
                  <div class="row mb-1">
                    <div class="col-sm-3">
                      <h6 class="mb-0 font-weight-bold">Adresse E-mail </h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                      <?php echo $para5 ?>
                    </div>
				    ...
				    <div class="row mb-1">
                    <div class="col-sm-3">
                      <h6 class="mb-0 font-weight-bold">Numéro GSM </h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                      <?php echo $para6 ?>
                    </div>
                    ...
                    <div class="col-sm-9 text-dark">
				     ...
				     <div class="row mb-1">
                    <div class="col-sm-3">
                      <h6 class="mb-0 font-weight-bold">Code Postal</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                      <?php echo $para10 ?>
                    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body bg-gradient-danger">
            ...
            >
			  ...
			  <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Adresse E-mail  </label>
                <div class="col-md-9">
			  ...
			  <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Numéro GSM </label>
                <div class="col-md-9">
			  ...
			  <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Adresse </label>
                <div class="col-md-9">
			 ...
			 <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" > Code postal </label>
                <div class="col-md-9">
            ...
            <div class="input-group mb-3">
              ...
              <div class="input-group-append">
			   ...
			   <div class="form-group row">
                ...
                <div class="col-md-9">
            <button name="custupdate" class=" btn-block btn btn-success"><span class="glyphicon glyphicon-edit"></span> Valider</button>		
                </div>		
              </div>
