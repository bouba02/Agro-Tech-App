...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">BOUTIQUE</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-danger mb-3">
				  ...
				  <span class=" text-danger display-4" > Achat de cultures</span>
...
<form method="POST" action="cbuy_redirect.php">
						...
						echo "<option value=' '>Selectionnez une culture</option>";
...
<input hidden name="tradeid" id="tradeid"  value="">
						...
						<td>   
						  <div class="form-group">     
							<input id="quantity" type="number" placeholder="Quantité Disponible" max="10" name="quantity" required class="form-control text-dark">   
						  </div> 
						</td>
						...
						<td>
						 <div class="form-group" >
						<button class="btn btn-success form-control" name="add_to_cart" type="submit" disabled >Ajoutez au Panier </button>
						</div>
						</td>
			...
			<h3 class=" text-white"> Details de la Commande</h3>
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-responsive-md btn-table display" id="myTable">
					<tr class=" bg-dange">
						<th width="40%">Nom d'article</th>
						<th width="10%">Quantité (en KG)</th>
						<th width="20%">Prix (en DH)</th>				
					...
					<td><a href="cbuy_crops.php?action=delete&id=<?php echo $values["item_id"]; ?>" type="button" class="btn btn-warning btn-block" >Supprimer</a></td>
...
?>
					...
					<tr class="text-dark">
						...
						<td align="right">DHS <?php echo number_format($total,2); ?></td>
			...
			<?php
							...
							require_once "StripePayment/config.php";
								...
								$session = \Stripe\Checkout\Session::create([
									...
									'mode' => 'payment',
									'success_url' => 'http://localhost/agriculture_portal-main/customer/cupdatedb.php',
    					...
    					?>
						<button class="btn btn-info form-control" name="pay" type="submit" id="checkout-button">Payer</button>
