...
header("location: ../fprofile.php");} // Redirecting To Home Page
...
// https://api.openweathermap.org/data/2.5/forecast?id=1275339&lang=fr&units=metric&APPID=870887df4d2b01335921fe396c69a360;

// $googleApiUrl ="https://api.openweathermap.org/data/2.5/forecast?id=" . $cityId . "&lang=en&units=metric&APPID=" . $apiKey;

// URL de l'API OpenWeatherMap pour récupérer les prévisions météorologiques
$googleApiUrl = "https://api.openweathermap.org/data/2.5/forecast?id=" . $cityId . "&lang=fr&units=metric&APPID=" . $apiKey;

// Explication des composantes de l'URL :
// - $cityId : L'identifiant de la ville pour laquelle vous souhaitez les prévisions.
// - "&lang=fr" : La langue de la réponse (dans ce cas, le français).
// - "&units=metric" : Les unités de température (dans ce cas, Celsius) dans la réponse.
// - "&APPID=" : Votre clé API OpenWeatherMap pour l'authentification.
...
<div class="container ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">Prévisions Météorologiques</span>
          </div>
        </div>
...
<script>window.myWidgetParam ? window.myWidgetParam : window.myWidgetParam = [];  window.myWidgetParam.push({id: 9,cityid: '<?php echo $cityId ?>',appid: '870887df4d2b01335921fe396c69a360',units: 'metric',containerid: 'openweathermap-widget-9',  });  (function() {var script = document.createElement('script');script.async = true;script.charset = "utf-8";script.src = "//openweathermap.org/themes/openweathermap/assets/vendor/owm/js/weather-widget-generator.js";var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(script, s);  })();</script>
    ...
    <thead>
          ...
          <th><center>Température (Max / Min)</center></th>
          <th><center>Description</center></th>
          <th><center>Humidité</center></th>
          <th><center>Vent</center></th>
