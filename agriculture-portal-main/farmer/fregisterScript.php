...
function is_valid_email($email)
{
	...
	global $error;
	 ...
	 if ($rowcount==true) {
		...
		<strong class="text-center text-dark">Cet e-mail existe déjà</strong>
...
<div class="alert alert-info alert-dismissible fade show text-center" id="popup" role="alert">
<strong class="text-center text-dark">Vos mots de passe ne correspondent pas. Veuillez taper avec précaution</strong>
<button type="button" class close" data-dismiss="alert" aria-label="Fermer">
	<span aria-hidden="true">&times;</span>
</button>
</div>
...
if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmpassword'])){
    ...
    {	
		...
		// 	<div class="alert alert-info alert-dismissible fade show text-center" id="popup" role="alert">
		// 	<strong class="text-center text-dark">Erreur lors de l'inscription de l'utilisateur</strong>
		// 	<button type="button" class="close" data-dismiss="alert" aria-label="Fermer">
		// 		<span aria-hidden="true">&times;</span>
		// 	</button>
		// </div>
		
		// ";// die("Erreur lors de l'inscription de l'utilisateur");
