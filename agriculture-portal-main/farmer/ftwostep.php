      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
                  ><i class="text-white fas fa-user-plus"></i> Connexion</span
                >
		  </a>
		  ...
		  <a class="nav-link dropdown-toggle text-success " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  ><i class="text-success fas fa-sign-in-alt"></i> Connexion</span
                >
		  </a>
...
<div class="container">
 ...
 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-info badge-pill mb-3">Connexion</span>
          </div>
        </div> 
...
<div class=" col-sm-8 mb-3 mx-auto text-center">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Authentication à Double Facteur</a>
  </div>
...
<form method=""  action="">
			...
			<strong class="text-center text-dark ">Code OTP envoyé avec Succès, vérifiez votre E-mail</strong>
			...
			<strong class="text-center text-dark ">Code OTP Invalide </strong>
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			</div>
                    ...
                    <label for="name" class="col-md-2 col-form-label"
                      ><h6 class="text-white font-weight-bold">Code OTP</h6>
                    </label>
					
                    <div class="col-md-6">
                      <input type="text" id="otp"  class="form-control" required placeholder="Entrer le code OTP" name="farmer_otp">				   
					   <span id="otp_error" class="field_error"></span>		
                    </div>
					
					<div class="offset-md-1 col-md-3">
                      <button class="btn btn-info btn-block text-dark " type="button"   onclick="send_otp()">Renvoyez le Code</button>
                    </div>
