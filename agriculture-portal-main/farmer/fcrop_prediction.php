...
<div class="container ">
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-success display-4" > Prédiction des Cultures </span>					
				  </div>
    ...
    <thead>
					...
					<th><center>Saison</center></th>
					<th><center>Prédiction</center></th>
...
<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-success display-4" > Result  </span>					
					...
					echo"Les cultures cultivées dans le ".$district." pendant la saison de ".$season." sont :- ";
					...
					$command = escapeshellcmd("/ML/crop_prediction/ZDecision_Tree_Model_Call.py $JsonState $JsonDistrict $JsonSeason");
