        ...
        <div class="row">
            <div class="col-md-12 ">
				...
				<div class="card-header bg-gradient-secondary d-flex">
					...
					<div class="ml-auto">
						<button class="btn btn-info" onclick="window.print()">Imprimé</button>
						<button class="btn btn-danger mr-2 " onclick="clearContent()">Effacer la conversation</button>					
					</div>								
				</div>

				 <div class="card-body chat-box rounded p1" id="chatbox"><span id="copy-popup" class="popup">Copié!</span></div>
							 ...
							 <div class="card-footer bg-gradient-secondary">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input id="sendButton" type="button" value="Envoyez" class=" form-control btn btn-success btn-block" />
                                    </div>
                                </div>
                            </div>
...
const apiKey = "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";   // Entrer votre apikey here
