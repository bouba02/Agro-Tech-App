...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Connexion Agriculteurs</a>
      ...
      <div class="tab-content py-3 px-3 px-sm-0 bg-gradient-inf" id="nav-tabContent">
           ...
           <div class="card card-body bg-gradient-warning">
                 ...
                 <form method="POST" action="">     
                    ...
                    <label for="email" class="col-md-3 col-form-label"
                      ><h6 class="text-white font-weight-bold">E-mail</h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
                      ...
                      />
				  			  		 ...
				  			  		 <div class="form-group row">
                <label for="pass" class="col-md-3 col-form-label text-white" > Mot de Passe </label>
			   <div class="col-9">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock"></i></span>
              </div>
              <input name="farmer_password" type="password"  class="input form-control" id="password" placeholder="Mot de Passe" required="true" aria-label="password" aria-describedby="basic-addon1" />
	    ...
	    <?php require("/Applications/MAMP/htdocs/agriculture-portal-main/footer.php");?>
