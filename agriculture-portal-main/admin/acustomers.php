...
<div class="container-fluid ">
    	 ...
    	 <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-danger badge-pill mb-3">CLIENTS</span>
          </div>
        </div>
          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<div class="card text-white bg-gradient-secondary mb-3">
				  ...
				  <span class=" text-default display-4" >  Liste des Clients  </span>
...
$sql = "SELECT cust_name, cust_id, email, phone_no, state, city, address, pincode FROM custlogin";
		 ...
		 <tr class="text-center">
							...
							<td > <button class="btn btn-sm btn-danger" > <a href="acdelete.php?id=<?php echo $res['cust_id']; ?>"  class=" nav-link text-white">Supprimer</a> </button> </td>
